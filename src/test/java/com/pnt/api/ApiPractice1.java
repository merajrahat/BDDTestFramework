...
*/
    ...
    public void getOneEmployee() {
        Response response = RestAssured.given().when().get(employeeEndpoint + 1).then().assertThat().statusCode(200).extract().response();
        System.out.println(response.asString());

        // store into JASONObject and print employee name
    ...
    public void postAEmployee() {
        ...
        //to validate the data from the post call made to db
    }
    ...
    public void updateARecord() {
        ...
        Response response = RestAssured.given().contentType(ContentType.JSON)
                .body(js.toString()).when().put(updateEndpoint + 1747).then().assertThat().statusCode(200).extract().response();
    ...
    public void deleteARecord() {
        ...
        Response response = RestAssured.given().contentType(ContentType.JSON)
                .delete(deleteEndpoint + 6012).then().extract().response();
